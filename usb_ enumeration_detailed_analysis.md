...
static uint8_t USBD_HID_CfgDesc[34] =
{
  ...
  0x81,       /*bEndpointAddress: Endpoint Address (IN),USB设备的端点地址.Bit7:IN(1)/OUT(0)方向,*/
  	      /*如果是控制端点可以忽略,Bit6-4:保留,BIt3-0:端点号*/
  ...
  0x0a,       /*bInterval: Polling Interval (10 ms),轮训数据传送端点的时间间隔,*/
